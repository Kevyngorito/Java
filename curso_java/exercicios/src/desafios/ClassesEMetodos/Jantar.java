...
public class Jantar {
	...
	public static void main(String[] args) {
		...
		System.out.println(p1.showResults() + "[Peso antes da refeição]");
		p1.eating(c3);
		p1.eating(c2);
		p1.eating(c1);
		System.out.println("Fiz a refeição completa (arroz, feijão e frango), após o jantar o meu peso é " + p1.weight + "Kgs\n");
		System.out.println(p2.showResults() + "[Peso antes da refeição]");
		p2.eating(c3);
		p2.eating(c1);
